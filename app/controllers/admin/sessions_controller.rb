class Admin::SessionsController < Admin::ApplicationController
  before_action :autherize, except: [:new, :create]
  def new
  end
  ...
  def create
  	...
  	if @moderator
	  	...
	  	redirect_to admin_moderators_url, notice: 'You have successfull signed in'
  	else

  		flash[:alert] = 'There was a problem with yor username or password'
  		render :new
  	end
  end
